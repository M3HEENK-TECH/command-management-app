    ...
    <div class="container-fluid">
        <div class="messaging">
            <div class="inbox_msg">
                <div class="inbox_people">
                    <div class="inbox_chat">
                        ...
                        @foreach($users as $user)
                            <a href="{{route("messaging.show",$user)}}">
                                <div class="chat_list">
                                    <div class="chat_people">
                            ...
                            @else
                                <div class="incoming_msg">
                                    <div class="incoming_msg_img"><img
                                            src="{{$msg->user->url}}" alt="sunil"></div>
                ...
                <div class="type_msg">
                    <form action="{{route("user.sendErrorMessage")}}" method="post">
                        @csrf
                        <input type="hidden" name="target_user_id" value="{{$active_user->id}}">
                        <div class="input_msg_write">
                            <input type="text" class="write_msg" name="message" placeholder="Votre message">
